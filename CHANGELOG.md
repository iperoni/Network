...
### Fixed
- Test 14: Mejor soporte para Linux - usa traceroute si está disponible, o tracepath
...
### Added
- Test 12: Soporte para Linux - obtiene IP, máscara, gateway, DNS y detecta DHCP
...
### Added
- Test 8: Agregado soporte para Linux - usa `ip link`, `ip addr` y `ethtool`
...
### Fixed
- Test 7: Ahora funciona en Linux - soporte para output de ping en inglés (soporta español Windows e inglés Linux)
