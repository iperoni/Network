...
5. **NO borrar** `agents.md` - es archivo local
6. **Commit y push**:
   ```bash
   git add -A
...
3. **Actualizar VERSION** a versión menor (ej: v1.25.1 si está en v1.25.0)
...
- **v1.25.x**: Fixes, mejoras menores, documentación
- **Ejemplo**: 
  - v1.25.0 → v1.25.1 (fix)
  - v1.25.0 → v1.26.0 (nueva feature)
