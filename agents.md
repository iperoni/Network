...
3. **Actualizar VERSION** a versión menor (ej: v1.24.4 si está en v1.24.3)
...
- **Ejemplo**: 
  - v1.24.0 → v1.24.1 (fix)
  - v1.24.3 → v1.25.0 (nueva feature)

---

## Notas Importantes

- **NO subir** el archivo `agents.md` a GitHub
